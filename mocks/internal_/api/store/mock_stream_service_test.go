...
// Write provides a mock function with given fields: ctx, tenant, subject, record
func (_m *StreamService) Write(ctx context.Context, tenant string, subject string, record *api.Record) error {
	ret := _m.Called(ctx, tenant, subject, record)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *api.Record) error); ok {
		r0 = rf(ctx, tenant, subject, record)
	} else {
		r0 = ret.Error(0)
	}
...
//   - subject string
//   - record *api.Record
func (_e *StreamService_Expecter) Write(ctx interface{}, tenant interface{}, subject interface{}, record interface{}) *StreamService_Write_Call {
	return &StreamService_Write_Call{Call: _e.mock.On("Write", ctx, tenant, subject, record)}
}

func (_c *StreamService_Write_Call) Run(run func(ctx context.Context, tenant string, subject string, record *api.Record)) *StreamService_Write_Call {
...
func (_c *StreamService_Write_Call) RunAndReturn(run func(context.Context, string, string, *api.Record) error) *StreamService_Write_Call {
	_c.Call.Return(run)
	return _c
}
